		...
		<div className="">
			<div className="tryyy bg_he">
				<nav className="navbar navbar-expand-lg ">
					<button type="button" id="sidebarCollapse" className='some_btn_11' >
						...
						<div className="">
							<div className="input-group ">
								<div className="input-group-prepend">
									<select
										className="form-control slect_11"
										id="exampleFormControlSelect1"
										value={category}
										onChange={(e) => setcategory(e.target.value)}>
										<option defaultValue="user" className="slect_11_option">
											User
										</option>
										<option defaultValue="company" className="slect_11_option">
											Company
										</option>
									</select>
								</div>
						...
						<ul className="mr-auto navbar-nav nav_11">
							<li className="nav-item me_1">
								<button
									...
									data-toggle="modal"
									data-target="#exampleAddStory">
									Add Story
								</button>
							</li>
							<li className="nav-item dropdown me_1">
								<button
									className="nav-item dropdown-toggle see_more_n"
									type="button"
								...
								<div
									...
									aria-labelledby="mentorDropdownButton">
									<button className="dropdown-item seemore_dropitem">
										<Link to="/help" className="helpheader">
											Help
										</Link>
									</button>
									<button className="dropdown-item seemore_dropitem">
										<Link to="/privacy" className="helpheader">
											Privacy
										</Link>
									</button>
								</div>
							...
							<li className="nav-item me_1">
								<button className="logout_btn_dd">
									<Link to="/" className="log_out_1">
										{" "}
										Logout{" "}
										<img
											src={logout}
			...
			<div
				...
				id="exampleAddStory"
				role="dialog"
				aria-labelledby="exampleAddStoryTitle"
				aria-hidden="true">
				<div className="modal-dialog modal-dialog-centered" role="document">
					<div className="modal-content some_try_height">
						<div className="modal-header">
							<h5 className="modal-title sigU" id="exampleAddStoryTitle">
								Add Your Story Here
							</h5>
							<button
								type="button"
						...
						<div className="modal-body pd_rr">
							...
							<button className="sigU_btn" onClick={getTheDataFromStory}>
								Submit
							</button>
			...
			<div
				...
				<div className="modal-dialog modal-dialog-centered" role="document">
					<div className="modal-content">
						<div className="modal-header">
							<h5 className="modal-title sigU" id="exampleModalCenterTitle">
								Add Your Post Here
							</h5>
							<button
								type="button"
						...
						<div className="modal-body pd_rr">
							...
							{/* dropdown button- sign in with google,2 more options */}
							<button className="sigU_btn" onClick={getTheDataFromPosts}>
								Submit
							</button>
