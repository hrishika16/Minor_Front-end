...
function Step3() {
    ...
    const [Health_Sciences, setHealth_Sciences] = useState('Health_Sciences')
    ...
    return (
        <div>
            ...
            <div className = "container wholeInterest">
                <div className = "row">
                    <div className = "col-lg-3 btnInterest">
                        <input type='button' value ={Exploratory} name = 'Exploratory' id='Exploratory' onClick={ e =>handleButtonClick(e)}/>
                        <br></br>
                        <input type='button'  value = "b1"  name = "b1" id='Exploratory' onClick={e =>handleButtonClick(e)}/>
                        <br></br>
                        <input type='button'  value ={Philosophy}  name = "Philosophy" id='Philosophy' onClick={e =>handleButtonClick(e)}/> 
                        <br></br>
                        <input type='button'  value ={BioTechnology}  name = "BioTechnology" id='BioTechnology' onClick={e =>handleButtonClick(e)}/>
                    </div>
                    <div className = "col-lg-3 btnInterest">
                        <input type='button'  value ={Technology}  name = "Technology" id='Technology' onClick={e =>handleButtonClick(e)}/>
                        <br></br>
                        <input type='button'  value ={Journalism}  name = "Journalism" id='Journalism' onClick={e =>handleButtonClick(e)}/> 
                        <br></br>
                        <input type='button'  value ={Enterprenuralism}  name = "Enterprenuralism" id='Enterprenuralism' onClick={e =>handleButtonClick(e)}/> 
                        <br></br>
                        <input type='button'  value ={Health_Sciences}  name = "Health_Sciences" id='Health_Sciences' onClick={e =>handleButtonClick(e)}/> 
                    </div>
                    <div className = "col-lg-3 btnInterest">
            ...
            <div className = "fieldDiv">
                ...
                <br></br>
                <button type = "btn" className = "submitBtnStep" onClick={handleSubmitBtn} >Submit</button>
                <br></br>
